...
public class SuggestedRestroomAdapter extends RecyclerView.Adapter<SuggestedRestroomAdapter.BuildingRestroomHolder> {
    ...
    public SuggestedRestroomAdapter(ArrayList<RestroomData> restroomData, ViewUserSuggestionsActivity context) {
    ...
    public BuildingRestroomHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.suggested_restrooms_item_list,parent,false);
    ...
    public void onBindViewHolder(@NonNull BuildingRestroomHolder holder, int position) {
        ...
        holder.btn_resolve_suggestion.setOnClickListener(view -> {
            context.deleteUserSuggestion(restroomDataList.getBuildingId());
        });
    }

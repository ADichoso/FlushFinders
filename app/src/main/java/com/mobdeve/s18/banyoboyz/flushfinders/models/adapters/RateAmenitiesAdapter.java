...
public class RateAmenitiesAdapter extends RecyclerView.Adapter<RateAmenitiesAdapter.AmenityHolder> {
    AmenityData[] amenityData;
    Context context;

    public RateAmenitiesAdapter(AmenityData[] amenityData, Context context) {
